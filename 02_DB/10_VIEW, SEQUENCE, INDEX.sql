 ...
 *   컬럼에 대하여 생성하는 객체
 * 
 * - 인덱스 내부 구조는 B* 트리 형식(자동 정렬) 으로 되어있음.
 * 
 * 
 * ** INDEX의 장점 **
...
WHERE TEST_ID = 'TEST500000'; -- 20/18/21/19 ms

-- 인덱스 사용 O
SELECT * FROM TB_INDEX_TEST 
WHERE TEST_NO = 500000; -- 3/1/2/0 ms
