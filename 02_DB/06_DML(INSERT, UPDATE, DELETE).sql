...
UPDATE EMPLOYEE2 
SET BONUS = 0.1
WHERE BONUS IS NULL; -- 14행 수정

SELECT  EMP_NAME, BONUS FROM EMPLOYEE2 ;  -- 확인
...
-- UPDATE 후 위에 SELECT 수행 -> 결화 확인 후 ROLLBACK
...
SELECT * FROM EMP_M01; 
SELECT * FROM EMP_M02; -- EMP_MO1과 겹치는 행 4행, 겹치지 않는 행 1행
