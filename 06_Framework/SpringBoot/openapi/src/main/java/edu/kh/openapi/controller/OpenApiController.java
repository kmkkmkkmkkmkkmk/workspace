...
public class OpenApiController {
	...
	public String ex2( Model model, 
		...
		// 인증키
		final String serviceKey = "A%2BppfTF1I%2F3InMNwYeQEj9GwVjGxmYO04481Nf7Z2xIO24H9gZ0ETrEMkpCasBu44b6OuCg%2BG2KDanOPWhVmrQ%3D%3D";
        ...
        BufferedReader rd;
        if(conn.getResponseCode() >= 200 && conn.getResponseCode() <= 300) { // 성공 시
