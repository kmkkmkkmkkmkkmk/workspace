...
/* 서비스 키 */
const serviceKey = "A+ppfTF1I/3InMNwYeQEj9GwVjGxmYO04481Nf7Z2xIO24H9gZ0ETrEMkpCasBu44b6OuCg+G2KDanOPWhVmrQ==";
...
region.addEventListener("change", e => {
  ...
  getUltraSrtFcst(e.target.value); // 해당 지역 초단기 예보 조회
});

getUltraSrtFcst("서울"); // 화면 로딩되면 서울 날씨 얻어오기
