...
function classTest(){
  ...
  arr[0].style.backgroundColor = "rgb(12,154,214)";
  arr[0].innerText = "arr[0] 입니다";
  
  arr[1].style.backgroundColor = "rgb(154,12,214)";
  arr[1].innerText = "arr[1] 입니다";

  arr[2].style.backgroundColor = "rgb(214,154,12)";
...
function readValue(){
  ...
  // "문자열".length : 문자열의 길이  
  // " 문자열 ".trim() : 양쪽 공백 제거
  // 입력요소값.value.trim().length == 0  :  아무것도 입력하지 않았다면
