...
public class Student  implements Comparable<Student> {
	...
	public Student() {	} // 기본 생성자 // ctrl + space + Enter
	...
	// A.equals(B) : A객체와 B객체가 가지고있는 
						//  필드의 값이 모두 같으면 true, 아님 false
	...
	// A.hashCode() == B.hashCode()의 결과도 true여야한다.
	// *************************************
