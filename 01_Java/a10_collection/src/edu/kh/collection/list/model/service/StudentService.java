...
public class StudentService {
	...
	public StudentService() {
		...
		studentList.add(new Student(3, 4, 72, "박광우", 'M', 7));
		studentList.add(new Student(5, 1, 5, "정유미", 'F', 100));
		studentList.add(new Student(2, 7, 50, "범스테드", 'M', 99));
		studentList.add(new Student(6, 3, 60, "차하린", 'F', 42));
		studentList.add(new Student(1, 2, 9, "이유하", 'F', 88));
	}
