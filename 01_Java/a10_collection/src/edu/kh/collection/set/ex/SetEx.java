...
public class SetEx {
	...
	// 컬렉션의 특징 : 크기 제한X, 다양한 기능, 객체만 저장
	// 제네릭 <T> : 컬렉션 타입 제한
	
	// Set(집합)
	// - 중복 데이터가 저장 불가(같은 객체를 덮어 씌움)
...
//		Set<String> set = new LinkedHashSet<String>();
	...
	public void ex2() {
		...
		// set의 내용을 순차(반복) 접근 할 수 있는 형태로 변경해서 반환
		...
		while(it.hasNext()) {
			...
			// E it.next() : 다음 요소(있어? - 있으면 꺼내) 꺼내서 반환
			String temp = it.next();
...
//					return;
		...
		// *** 내가 한건데 수정 및 생각 해보기 ***    + 위에 코드 업그레이드 해보기 //
//		int lottomoney = sc.nextInt();
//		
...
//			if(lottomoney == 3000) {
//				
//			} else if (lottomoney == 5000) {
//				
//			} else if(lottomoney < 1000 ){
