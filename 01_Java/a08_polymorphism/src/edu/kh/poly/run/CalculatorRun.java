...
import edu.kh.poly.model.dto.KMKCalculator;
import edu.kh.poly.model.dto.KMKCalculatorV2;
...
public class CalculatorRun {
	...
	public static void main(String[] args) {
		...
		//    (다형성)
		 Calculator calc = new KMKCalculator();
		// Calculator calc = new KMKCalculatorV2();
