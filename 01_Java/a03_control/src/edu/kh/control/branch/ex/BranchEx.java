...
public class BranchEx {
	...
	public void ex2() {
		...
		// 방법 1. while문
//		int input = -1; // 아래 while 에 0이 들어가면 바로 멈춰서 -1 넣음
//		
...
//		}
		...
		// 방법 2. do=while문
//		int input; // 값을 지정 안해도되고 아무 값이나 넣어도됨
//		
//		do {
//			System.out.print("입력 : ");
//			input = sc.nextInt();
...
//		}while(input != 0 );
	...
	// 중첩 반복문에서 분기문 동작 확인
	public void ex3() { // for{if} 문이 if{for}문보다 조건을 제어하기 쉽다!
...
//		System.out.println(answer); // 입시로 답안 확인
		
		int count = 1; // 입력 횟수를 저장용 변수
