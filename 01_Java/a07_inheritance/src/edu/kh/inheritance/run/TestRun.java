...
public class TestRun {
	public static void main(String[] args) {
		...
		// -> 단점 : 개발자가 직접 작성한 import 구문이 사라질 수도 있따.
		...
		// 아무리 상속 받았다고해도 private은 직접 접근이 불가능하다!
		// (부모님의 개인적인 것을 마음대로 건드릴 수 없다..)
//		c1.money = 10;
		
		// 대신 간접 접근 방식 getter/setter 이용 가능
		...
		System.out.println(c3.getHouse());		// Child
