...
//		String input = sc.next(); // 문자열 (단어) 입력 받기 
		...
		// true  : 검색 결과 없음
		// false : 검색 결과가 존재함
		boolean flag = true;  //<< 불리언 트루 펄스 구문은 많이 사용한다하심
...
//		}
		...
		// 향상된 for문 : 모든 배열 요소를 접근하는 용도의 for문 - 항상 1씩 증가함
		// 장점 : 작성이 간단함
		// 단점 : 시작, 끝, 증감, 인덱스 지정 불가능
		
		// for(배열요소의 자료형으로된 변수 : 배열명 )
		// 		 -> 오른쪽에 작성한 배열의 요소를 
		//			순서대로 하나씩 꺼내와 대입
